...
router.post('/', async (req, res) => {
    try {
        ...
        const newLevel = await DistributorLevel.create({
            ...
            minPoints: minPoints != null && minPoints !== '' ? parseInt(minPoints, 10) : 0,
            maxPoints: maxPoints != null && maxPoints !== '' ? parseInt(maxPoints, 10) : null,
...
router.put('/:id', async (req, res) => {
    try {
        ...
        const upd = {
            ...
            minPoints: minPoints !== undefined ? minPoints : levelRecord.minPoints,
            maxPoints: maxPoints !== undefined ? maxPoints : levelRecord.maxPoints,
            useActiveFansForUpgrade: useActiveFansForUpgrade !== undefined ? !!useActiveFansForUpgrade : levelRecord.useActiveFansForUpgrade,
